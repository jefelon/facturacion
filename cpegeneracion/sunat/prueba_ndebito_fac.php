...
$header[0]['idcomprobante']		="8";//1FACTURA 3BOLETA 7NCREDITO 8NDEBITO
$header[0]['serie']				="F001";
$header[0]['numero']			="1";
...
$header[0]['referencedocumenttypecode']="1";
$header[0]['referenceid']			="F001-1";//factura

$header[0]['idtiponotacredito']		="2";//cat 10
$header[0]['description']			="AUMENTO EN EL VALOR";
...
$detalle[0]['nro']				="1";
$detalle[0]['idmedida']			="ZZ";
$detalle[0]['cantidad']			="1";
$detalle[0]['idproducto']		="";
$detalle[0]['codigo']			="";
$detalle[0]['detalle']			=null;
$detalle[0]['cdsc']				="AMPLIACION DE GARANTIA";
...
$r = run(datatoarray($header, $detalle, $empresa, 'DebitNote'), $_SERVER['DOCUMENT_ROOT'] ."granadosllantas/facturacion/facturasunat/sunat/send/", $_SERVER['DOCUMENT_ROOT'] ."granadosllantas/facturacion/facturasunat/sunat/cdr/", $nodo="", "DebitNote", true);
