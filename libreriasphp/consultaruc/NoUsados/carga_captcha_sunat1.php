...
function recibe_imagen_sunat($url, $arquivo) {
  $cookie = 'http://localhost:8080/sisgescom/sunat/receita.txt'; //Importantissimo que o caminho esteja correto e com permissão CHMOD 777
...
print "<img src='{$img}' />" .
      '<form action="carga_registro_sunat.php" method="POST">
         captcha
