...
// Ver:         $Id: pdf417_compressors.inc.php 506 2006-02-04 15:56:23Z ljp $
//
...
class TextCompressor {
    ...
    function TextCompressor(&$aCollector) {
...
class NumericCompressor {
    private $iCollector=NULL;
    function NumericCompressor(&$aCollector) {
        $this->iCollector =& $aCollector;
    }
...
class ByteCompressor {
    private $iCollector=NULL;
    function ByteCompressor(&$aCollector) {
        $this->iCollector =& $aCollector;
    }
