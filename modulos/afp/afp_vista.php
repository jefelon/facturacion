...
<title>Declaración de Documentos</title>
...
{	
	$.ajax({
		...
		success: function(html){
			$('#div_declaraciondocumentos_tabla').html(html);
		},
		complete: function(){			
			$('#div_declaraciondocumentos_tabla').removeClass("ui-state-disabled");
		}
	});     
}

function declaraciondocumentos_form(act,idf)
{
	$.ajax({
		type: "POST",
		url: "afp_form.php",
		...
		data: ({
			action: act,
            afp_id:	idf,
			vista:	'declaraciondocumentos_tabla'
		}),
		beforeSend: function() {
			$('#msj_declaraciondocumentos').hide();
			$('#div_declaraciondocumentos_form').dialog("open");
			$('#div_declaraciondocumentos_form').html('Cargando <img src="../../images/loadingf11.gif" align="absmiddle"/>');
        },
		success: function(html){
			$('#div_declaraciondocumentos_form').html(html);
		}
	});
}

function eliminar_declaraciondocumentos(id)
{   
	$('#msj_declaraciondocumentos').hide();
	if(confirm("Realmente desea eliminar?")){
		$.ajax({
			...
			beforeSend: function() {
				$('#msj_declaraciondocumentos').html("Cargando...");
				$('#msj_declaraciondocumentos').show(100);
			},
			success: function(html){
				$('#msj_declaraciondocumentos').html(html);
			},
			complete: function(){
