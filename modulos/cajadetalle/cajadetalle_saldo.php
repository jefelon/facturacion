...
if($_POST['action']=="actualizar"){
    ...
    $cierre = mostrarFechaHora($cdet['tb_caja_cierre']);
                ...
                <tr>
                    ...
                    <td style="width:50%;">
                        <input id="txt_fec_ape" name="txt_fec_ape" class="timepicker"
                               ...
                               value="<?php echo $apertura ?>" maxlength="20" readonly/>
                    </td>
                <tr>
                <tr>
                    <td style="width:30%;">
                    ...
                    <td style="width:50%;">
                        <input id="txt_fec_cie" name="txt_fec_cie" class="timepicker"
                               style="text-align:right; font-size:12px" size="30"
                               value="<?php echo $cierre ?>" maxlength="20" readonly/>
                    </td>
                <tr>
                    <td style="width:30%;">
                    ...
                    <td style="width:50%;">
                        <input name="txt_mon_inicial" type="text" class="venpag_moneda" id="txt_mon_inicial"
                               style="text-align:right; font-size:12px; " size="30" readonly maxlength="20" value="<?php echo formato_moneda($inicial) ?>">
                    </td>
                </tr>
            </table>
        </fieldset>
...
$dts1=$oIngreso->mostrar_filtro_fechahora($_SESSION['empresa_id'],$_POST['cmb_fil_caj_id'],fechahora_mysql($apertura),fechahora_mysql($cierre),$_POST['cmb_fil_cue_id'],$_POST['cmb_fil_subcue_id'],$_POST['cmb_fil_doc_id'],$_POST['txt_fil_ing_numdoc'],$_POST['hdd_fil_cli_id'],$_POST['cmb_fil_ing_est']);
...
<?php
$dts1=$oEgreso->mostrar_filtro_fechahora($_SESSION['empresa_id'],$_POST['cmb_fil_caj_id'],fechahora_mysql($apertura),fechahora_mysql($cierre),$_POST['cmb_fil_cue_id'],$_POST['cmb_fil_subcue_id'],$_POST['cmb_fil_doc_id'],$_POST['txt_fil_egr_numdoc'],$_POST['hdd_fil_pro_id'],$_POST['cmb_fil_egr_est']);
