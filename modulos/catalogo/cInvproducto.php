...
class cInvproducto{
	...
	function stock_kardex($cat_id,$alm_id,$fecini,$fecfin,$emp_id)
	{
		...
		$stock_unidad1=$cantidad_entrada-$cantidad_salida;
		
		return $stock_unidad1;
	}
	...
	function costo_ponderado_total($cat_id,$alm_id,$fecini,$fecfin,$stock_comparacion,$costo_soles,$costo_dolares,$emp_id)
	{
		$oHistorial = new cHistorial();
		$oKardex = new cKardex();
