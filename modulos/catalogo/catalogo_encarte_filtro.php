...
<br>
  ...
  <a href="#" onClick="catalogo_encarte_tabla()" id="btn_encarte_filtrar">Filtrar</a>
  <a href="#" onClick="catalogo_encarte_filtro()" id="btn_pro_resfil">Restablecer</a>
