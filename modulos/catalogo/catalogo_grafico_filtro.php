...
<form name="for_fil_pro" id="for_fil_ven" action="" method="post">
...
<br>
  ...
  <a href="#" onClick="catalogo_grafico_tabla()" id="btn_compra_filtrar">Filtrar</a>
  <a href="#" onClick="catalogo_grafico_filtro()" id="btn_pro_resfil">Restablecer</a>
</fieldset>
</form>