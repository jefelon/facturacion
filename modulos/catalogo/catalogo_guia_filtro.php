...
$(function() {
	...
	$("#txt_fil_pro_nom").keyup(function() {
		catalogo_guia_tabla();
	});
	
	$("#txt_fil_pro_cod").keyup(function() {
		catalogo_guia_tabla();
	});
});
</script>
...
<br>
  ...
  <a href="#" onClick="catalogo_guia_tabla()" id="btn_guia_filtrar">Filtrar</a>
  <a href="#" onClick="catalogo_guia_filtro()" id="btn_pro_resfil">Restablecer</a>
</fieldset>