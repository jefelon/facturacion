...
if($_POST['cmb_fil_pro_alm']>0)
{
	$dts1=$oCatalogo->catalogo_filtro_stock($_POST['txt_fil_pro_nom'],$_POST['txt_fil_pro_cod'],$dc,$_POST['cmb_fil_pro_mar'],$_POST['cmb_fil_pro_est'],$cadena_atr,$_POST['chk_fil_catven'],$_POST['chk_fil_catcom'],$_POST['chk_fil_unibas']);
...
//____
	...
	$pdf->Cell(150,4,utf8_decode($emp_razsoc),0,1,'L');
	...
	*****************************************************/
	...
	$aSimpleHeader[1]['WIDTH'] = 37;
	
	$aSimpleHeader[2] = $table_default_header_type;
	$aSimpleHeader[2]['TEXT'] = "CATEGORIA";
	$aSimpleHeader[2]['WIDTH'] = 70;
	
	$aSimpleHeader[3] = $table_default_header_type;
	$aSimpleHeader[3]['TEXT'] = "UNIDAD";
	$aSimpleHeader[3]['WIDTH'] = 14;
	
	$aSimpleHeader[4] = $table_default_header_type;
	$aSimpleHeader[4]['TEXT'] = "PRECIO VENTA";
	$aSimpleHeader[4]['WIDTH'] = 22;
	
	$aSimpleHeader[5] = $table_default_header_type;
	$aSimpleHeader[5]['TEXT'] = utf8_decode($alm_nom[0]);
	$aSimpleHeader[5]['WIDTH'] = 19;
	
	$aSimpleHeader[6] = $table_default_header_type;
	$aSimpleHeader[6]['TEXT'] = utf8_decode($alm_nom[1]);
	$aSimpleHeader[6]['WIDTH'] = 19;
	...
	if($num_rows>=1)
	{
		...
		//{
			...
			$data[3]['TEXT'] = utf8_decode($dt1['tb_unidad_abr']);
				
			$data[4]['TEXT'] = formato_money($dt1['tb_catalogo_preven']);
			$data[4]['T_ALIGN'] = 'R';
