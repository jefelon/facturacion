            ...
            <tbody>
                <?php
					while($dt1 = mysql_fetch_array($dts1)){
						...
						$rws1 = $oKardex->mostrar_kardex_tipoperacion_por_producto($dt1['tb_catalogo_id'], $_POST['alm_id'],'1');
					...
					?>
                        <tr>
                          <!--<td><?php //echo $dt1['tb_presentacion_cod']?></td>-->
                            ...
                            <td align="right"><?php if($dt1['tb_catalogo_precosdol']!=0)echo $dt1['tb_catalogo_precosdol']?></td>
                            ...
                            <a class="btn_editar" href="#editar" onClick="producto_form('editar','<?php echo $dt1['tb_producto_id']?>')">Editar Producto</a>
