...
<br>
  ...
  <a href="#" onClick="catalogo_traspaso_tabla()" id="btn_traspaso_filtrar">Filtrar</a>
  <a href="#" onClick="catalogo_traspaso_filtro()" id="btn_pro_resfil">Restablecer</a>
  </br>
