...
if($_POST['alm_ori']>0)
{
	$dts1=$oCatalogo->catalogo_traspaso_filtro($_POST['pro_nom'],$_POST['pro_cod'],$dc,$_POST['pro_mar'],$_POST['pro_est'],$_POST['alm_ori'],$_POST['verven'],$_POST['vercom'],$_POST['unibas'],$_POST['limit']);
...
if($_POST['alm_ori']=="")
{
	echo 'Por favor seleccione Almacén de Origen para mostrar productos.';
}
?>
