...
<div id="div_consulta_stock">
        ...
        <table cellspacing="1" id="tabla_producto" class="tablesorter">
            <thead>
                <tr>
                  <th>NOMBRE</th>
                  <th align="right" title="PRECIO SUGERIDO (PRECIO DE VENTA PROMEDIO)">PV. PROM</th>
                        ...
                        <tr>
                          <td>
                            ...
                            <?php
														...
														{
                            echo '<span class="alerta_r" title="PRODUCTO EN PROMOCIÓN">Promo '.$enc_despor.'%</span>';
														}
														?>
                          ...
                          <td align="right">
													<?php echo formato_money(moneda_mysql($precio_sugerido))?>
                          </td>
