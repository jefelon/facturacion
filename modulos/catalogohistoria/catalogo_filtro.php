...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><label for="txt_fil_ven_fec1">Fecha:</label>
		<input name="txt_fil_ven_fec1" type="text" id="txt_fil_ven_fec1" value="<?php echo $fec?>" size="8" readonly>
		<label for="txt_fil_ven_fec2">-</label>
		<input name="txt_fil_ven_fec2" type="text" id="txt_fil_ven_fec2" value="<?php echo $fec?>" size="8" readonly>
