...
if($_POST['action_direccion']=="insertar")
{
	if(!empty($_POST['txt_cli_direccion']))
	{

			$oCliente->insertar_direccion(
				$_POST['txt_cli_direccion'],
                $_POST['hdd_cli_id']
				);
			...
			$data['dir_id']=$cli_id;
			$data['dir_msj']='Se registró cliente correctamente.';
...
if($_POST['action_direccion']=="editar")
{
	if(!empty($_POST['txt_cli_nom']))
	{
