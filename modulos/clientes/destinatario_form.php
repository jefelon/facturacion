...
<input name="hdd_cli_id" id="hdd_cli_id" type="hidden" value="<?php echo $_POST['cli_id']?>">
    <table>
    	...
    	<tr>
            ...
            <a id="validar_ruc_des" href="#validar" onClick="buscar()">Validar Ruc</a>
