...
<form name="for_fil" id="for_fil" target="_blank" action="" method="post">
    <fieldset><legend>Filtro</legend>
        <label for="txt_fil_fec1">Fecha que Consiguio:</label>
        ...
        <a href="#" onClick="comisionista_tabla()" id="btn_filtrar">Filtrar</a>
        <a href="#" onClick="comisionista_filtro()" id="btn_resfil">Restablecer</a>
    </fieldset>
</form>