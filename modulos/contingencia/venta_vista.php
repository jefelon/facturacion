...
<title>Resumen de Contingencia</title>
...
function venta_filtro()
{
	$.ajax({
		type: "POST",
		url: "../contingencia/venta_filtro.php",
		async:true,
		dataType: "html",                      
		//data: ({
...
$(function() {
	...
	$( "#div_venta_form" ).dialog({
		title:'Información de Resumen de Contingencia',
		autoOpen: false,
		resizable: false,
		height: 'auto',
		width: 700,
    ...
    <article class="content">
    	<div class="contenido">
            ...
            <table align="center" class="tabla_cont">
                  <tr>
                    <td class="caption_cont">RESUMEN DE CONTINGENCIA</td>
                  </tr>
                  <tr>
