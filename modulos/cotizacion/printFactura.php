...
<table style="width: 100%; border-top: 0.9px solid #eeeeee; padding-top: 10px; border-collapse:collapse;">
    <tbody style="border-bottom: 0.9px solid #eeeeee">
        ...
        <?php
            $dts = $oCotizacion->mostrar_venta_detalle_ps($id);
            $cont = 1;
            while($dt = mysql_fetch_array($dts)){
                $codigo = $cont;
        ...
        ?>
            ...
            <?php if($dt["tb_ventadetalle_tipven"]==1){ ?>
                ...
                <td style="text-align: right"><?php echo formato_moneda($dt["tb_ventadetalle_valven"]/$dt["tb_ventadetalle_can"]); ?></td>
                <td style="text-align: right"><?php echo ((($dt["tb_ventadetalle_valven"]+$dt["tb_ventadetalle_igv"])/$dt["tb_ventadetalle_can"])+formato_moneda(($dt["tb_ventadetalle_des"]*1.18)))*$dt["tb_ventadetalle_can"]; ?></td>
            <?php }else{ ?>
                <td style="text-align: left"><?php echo $cont; ?></td>
...
<?php 
    ...
    //echo $s;
    echo "<img src=\"generate.php?$s\" name=barcode style=\"width: 6cm; height: 2cm;\">";
