...
<head>
    ...
    <script type="text/javascript">
        function croquis_tabla()
        {
            $.ajax({
                type: "POST",
                url: "croquis_tabla.php",
                async:true,
                dataType: "html",
                data: ({
        ...
        function croquis_form(act,idf)
        {
            $.ajax({
                type: "POST",
                url: "croquis_form.php",
                async:true,
                dataType: "html",
                data: ({
                    action: act,
                ...
                beforeSend: function() {
                    $('#msj_croquis').hide();
                    $('#div_croquis_form').dialog("open");
                    $('#div_croquis_form').html('Cargando <img src="../../images/loadingf11.gif" align="absmiddle"/>');
                },
                success: function(html){
                    $('#div_croquis_form').html(html);
                }
            });
        }
        ...
        function croquis_distribucion_form(act,idf,veh_id)
        {
            $.ajax({
                type: "POST",
                url: "../croquis/croquis_asiento_form.php",
                async:true,
                dataType: "html",
                data: ({
                    action: act,
                ...
                beforeSend: function() {
                    $('#msj_croquis').hide();
                    $('#div_croquis_distribucion_form').dialog("open");
                    $('#div_croquis_distribucion_form').html('Cargando <img src="../../images/loadingf11.gif" align="absmiddle"/>');
                },
                success: function(html){
                    $('#div_croquis_distribucion_form').html(html);
                }
            });
        }
        ...
        $(function() {
            ...
            $( "#div_croquis_form" ).dialog({
                ...
                buttons: {
                    ...
                    Cancelar: function() {
                        $('#for_cro').each (function(){this.reset();});
                        $( this ).dialog( "close" );
                    }
                }
            });
            $( "#div_croquis_distribucion_form" ).dialog({
        ...
        <div class="contenido">
            <div class="contenido_des">
                <table align="center" class="tabla_cont">
                    <tr>
                        <td class="caption_cont">CROQUIS</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td width="25" align="left" valign="middle"><a id="btn_agregar" href="#" onClick="croquis_form('insertar')">Agregar</a></td>
                                    <td width="25" align="left" valign="middle"><a id="btn_actualizar" href="#">Actualizar</a></td>
                                    <td align="left" valign="middle">&nbsp;</td>
                                    <td align="right"><div id="msj_croquis" class="ui-state-highlight ui-corner-all" style="width:auto; float:right; padding:2px; display:none"></div></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
            ...
            <div id="div_croquis_form">
            </div>
            <div id="div_croquis_distribucion_form">
            </div>
            <div id="div_croquis_tabla" class="contenido_tabla">
            </div>
        </div>
    </article>
</div>
