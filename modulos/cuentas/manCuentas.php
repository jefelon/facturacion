    ...
    <article class="content">
		...
		<section>
            ...
            <table align="center" class="tabla_cont">
                  <tr>
                    <td class="caption_cont">CUENTAS</td>
                  </tr>
                  <tr>
            ...
            <table width="95%" border="0" align="center">
                        <tr>
                          <td height="20"><form name="form2" id="form2">
                            ...
                            <select name="jumpMenu2" id="jumpMenu2" onChange="MM_jumpMenu('parent',this,0)">
                              <option value="manCuentas.php?id_ele=1" <?php if($ele==1)echo 'selected'?>>ENTRADAS</option>
                              <option value="manCuentas.php?id_ele=2" <?php if($ele==2)echo 'selected'?>>SALIDAS</option>
                            </select>
                          </form></td>
                      </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <table width="300" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td width="20" align="left" valign="middle"><a href="manCuentas.php?action=insertar1" title="Agregar"><img src="../../images/iconos/add.png" alt="Agregar" width="20" height="20" border="0"></a></td>
                              <td width="20" align="left" valign="middle"><a href="manCuentas.php?action=refrescar"><img src="../../images/iconos/refresh.png" alt="Refrescar" width="20" height="20" border="0"></a></td>
                            ...
                            <table width="300" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td align="left" valign="middle"><?php if (isset($_SESSION['cue'])){?>
                                  <a href="manCuentas.php?action=insertar2">Agregar</a>
                        ...
                        <table width="320" border="0">
                         ...
                         ?>
                              <tr>
                                ...
                                <td width="21" align="center"><a href="manCuentas.php?action=editar1&amp;id1=<?php echo $d1?>"><img src="../../images/iconos/edit.png" alt="Editar" width="14" height="14" border="0"></a></td>
                                <td width="20" align="center"><a href="manCuentas.php?action=eliminar1&amp;id1=<?php echo $d1?>" onClick="return mensaje('Realmente Desea Eliminar?')"><img src="../../images/iconos/delete.png" alt="Eliminar" width="14" height="14" border="0"></a></td>
                              </tr>
                              <?php
                         }
                         ?>
                    ...
                    <form name="form1" action="rCuenta.php?action=<?php echo $_GET['action']?>" method="post">
                    ...
                    <input name="hdd_ele" type="hidden" value="<?php echo $ele?>">
                         ...
                         ?>        
                                <tr>
                                  ...
                                  <td width="21" align="center"><a href="manCuentas.php?action=editar2&amp;id2=<?php echo $d2?>"><img src="../../images/iconos/edit.png" alt="Editar" width="14" height="14" border="0"></a></td>
                                  <td width="20" align="center"><a href="manCuentas.php?action=eliminar2&amp;id2=<?php echo $d2?>" onClick="return mensaje('Realmente Desea Eliminar?')"><img src="../../images/iconos/delete.png" alt="Eliminar" width="14" height="14" border="0"></a></td>
                                  </tr>
                                <?php
                         }
                         ?>
                            ...
                            <div id="div_insertar2" style="display:<?php if($_GET['action']=="insertar2" or $_GET['action']=="editar2"){echo "block";} else{ echo "none";}?>">
                              <table width="320" id="tab_insertar3">
                                <form name="form1" action="rSubcuenta.php?action=<?php echo $_GET['action']?>" method="post">
                          ...
                          <td height="20" align="left" valign="middle">
                            <form name="form" id="form">
                              Ordenar por: <select name="jumpMenu" id="jumpMenu" onChange="MM_jumpMenu('parent',this,0)">
                                <option value="manCuentas.php?oby=des" <?php if($oby=='des')echo 'selected'?>>Descripción</option>
                                <option value="manCuentas.php?oby=ord" <?php if($oby=='ord')echo 'selected'?>>N° Orden</option>
                                </select>
                            </form></td>
                          <td valign="top">&nbsp;</td>
                          </tr>
                        <tr>
                         ...
                         ?>
                              <tr>
                                ...
                                ?>
                                <td width="15%" valign="top" bgcolor="<?php echo $color1?>"><a href="manCuentas.php?ge1=<?php echo $dt1['tb_cuenta_id']?>"><?php echo $dt1['tb_cuenta_cod'];?></a></td>
                                <td width="70%" valign="top" bgcolor="<?php echo $color1?>" title="<?php echo $dt1['tb_cuenta_id']?>"><a href="manCuentas.php?ge1=<?php echo $dt1['tb_cuenta_id']?>"><?php echo $dt1['tb_cuenta_des'];?></a></td>
                                <td width="15%" align="center" valign="top" bgcolor="<?php echo $color1?>"><a href="manCuentas.php?ge1=<?php echo $dt1['tb_cuenta_id']?>"><?php echo $dt1['tb_cuenta_ord'];?></a></td>
                                </tr>
                              <?php
                         }
                        ...
                        // echo "Seleccione una Cuenta";
                         ...
                         ?>
                              <tr>
                                ...
                                ?>
                                <td width="15%" valign="top" bgcolor="<?php echo $color1?>"><a href="manCuentas.php?ge2=<?php echo $dt2['tb_subcuenta_id']?>"><?php echo $dt2['tb_subcuenta_cod'];?></a></td>
                                <td width="70%" valign="top" bgcolor="<?php echo $color1?>" title="<?php echo $dt2['tb_subcuenta_id']?>"><a href="manCuentas.php?ge2=<?php echo $dt2['tb_subcuenta_id']?>"><?php echo $dt2['tb_subcuenta_des'];?></a></td>
                                <td width="15%" align="center" valign="top" bgcolor="<?php echo $color1?>"><a href="manCuentas.php?ge2=<?php echo $dt2['tb_subcuenta_id']?>"><?php echo $dt2['tb_subcuenta_ord'];?></a></td>
                                </tr>
                              <?php
                         }
