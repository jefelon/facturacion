<?php
class cCompra{
	function insertar($fec,$fecven,$doc_id,$numdoc,$mon,$tipcam,$pro_id,$subtot,$des,$descal,$fle,$tipfle,$ajupos,$ajuneg,$valven,$igv,$tot,$alm_id,$est,$usu_id,$emp_id){
	...
	VALUES (
	NOW( ) , NOW( ) ,  '$fec', '$fecven',  '$doc_id',  '$numdoc', '$mon', '$tipcam', '$pro_id',  '$subtot',  '$des',  '$descal',  '$fle',  '$tipfle',  '$ajupos',  '$ajuneg',  '$valven',  '$igv',  '$tot',  '$alm_id',  '$est',  '$usu_id',  '$emp_id'
	);"; 
	$oCado = new Cado();
	$rst=$oCado->ejecute_sql($sql);
	return $rst;	
	}
	function insertar_detalle($cat_id,$can,$preuni,$des, $imp, $igv, $fle, $cosuni, $com_id){
	...
	VALUES (
	'$cat_id',  '$can',  '$preuni', '$des',  '$imp',  '$igv',  '$fle',  '$cosuni', '$com_id'
	);"; 
	$oCado = new Cado();
	$rst=$oCado->ejecute_sql($sql);
	return $rst;	
