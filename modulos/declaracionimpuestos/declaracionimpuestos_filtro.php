...
<form name="for_fil" id="for_fil" target="_blank" action="" method="post">
    <fieldset><legend>Filtro</legend>
        <label for="txt_fil_fec1">Fecha de Declaración:</label>
        ...
        <a href="#" onClick="declaracionimpuestos_tabla()" id="btn_filtrar">Filtrar</a>
        <a href="#" onClick="declaracionimpuestos_filtro()" id="btn_resfil">Restablecer</a>
    </fieldset>
</form>