...
$dts1=$oIngreso->mostrar_filtro_fec($emp_id,fecha_mysql($_POST['txt_fil_caj_fec1']),fecha_mysql($_POST['txt_fil_caj_fec2']),$_POST['cmb_fil_cue_id'],$_POST['cmb_fil_subcue_id'],$_POST['txt_fil_ing_doc'],$_POST['cmb_fil_cli_id'],$_POST['cmb_fil_entfin_id'],$_POST['cmb_fil_ing_est'],$_POST['cmb_fil_caj_id'],$_POST['cmb_fil_ref_id']);
...
?>
        <tr>
          ...
          <?php /*?><td><?php echo $dt1['tb_referencia_nom']?></td><?php */?>
...
?>
        ...
        <tr class="even">
          <td colspan="8"><strong>TOTAL <?php echo $num_rows." registros";?></strong></td>
          <td align="right"><strong><?php echo formato_money($sum_mon)?></strong></td>
          <td colspan="3">&nbsp;</td>
        </tr>
      </table>
<input name="hdd_ingreso_total" id="hdd_ingreso_total" type="hidden" value="<?php echo $sum_mon?>">