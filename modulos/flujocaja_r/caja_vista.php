...
<title>Consulta Caja Terceros</title>
...
function ingreso_form(act,idf){
	$.ajax({
		type: "POST",
		url: "../ingreso_r/ingreso_form.php",
		async:true,
		dataType: "html",                      
		data: ({
			action: act,
    ...
    <article class="content">
    	<div class="contenido">
            ...
            <table align="center" class="tabla_cont">
                  <tr>
                    <td class="caption_cont">CONSULTA CAJA TERCEROS</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <tr>
                      <td width="16%" align="left" valign="middle"><a id="btn_agregar_ing" title="Agregar (A+G)" href="#" onClick="ingreso_form('insertar')">Agregar Ingreso</a></td>
                      <td width="16%" align="left" valign="middle"><a id="btn_agregar_gas" title="Agregar (A+G)" href="#" onClick="gasto_form('insertar')">Agregar Gasto</a></td>
            ...
            <div class="ui-widget-header ui-corner-all" style="width:auto; padding:2px; margin:3px">CONSULTA SALDO</div>
