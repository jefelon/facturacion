<?php
session_start();
require_once ("../gasto - Copia/Cado.php");
require_once ("../gasto - Copia/Clases/cEmpresa.php");
$oEmpresa = new cEmpresa();
require_once ("../gasto - Copia/Clases/cGasto.php");
$oGasto = new cGasto();
require_once("../gasto - Copia/Clases/cCuenta.php");
$oCuenta = new cCuenta();
require_once("../gasto - Copia/Clases/cSubcuenta.php");
$oSubcuenta = new cSubcuenta();
require_once ("../gasto - Copia/Clases/cProveedor.php");
$oProveedor = new cProveedor();
require_once ("../gasto - Copia/Clases/cEntfinanciera.php");
$oEntfinanciera = new cEntfinanciera();

require_once("../gasto - Copia/Libreria/formato.php");
require_once("../gasto - Copia/Libreria/date.php");
...
//____
	//Table Base Classs
	require_once("../gasto - Copia/fpdf_table/class.fpdf_table.php");
