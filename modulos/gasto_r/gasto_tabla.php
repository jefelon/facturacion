...
$dts1=$oGasto->mostrar_filtro_fec($emp_id,fecha_mysql($_POST['txt_fil_gas_fec1']),fecha_mysql($_POST['txt_fil_gas_fec2']),$_POST['cmb_fil_cue_id'],$_POST['cmb_fil_subcue_id'],$_POST['cmb_fil_pro_id'],$_POST['cmb_fil_entfin_id'],$_POST['cmb_fil_gas_est'],$_POST['cmb_fil_caj_id'],$_POST['cmb_fil_mon_id']);
