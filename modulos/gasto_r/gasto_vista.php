...
<title>Gastos - Caja Terceros</title>
    ...
    <article class="content">
    	<div class="contenido">
            ...
            <table align="center" class="tabla_cont">
                  <tr>
                    <td class="caption_cont">GASTOS - CAJA TERCEROS</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <tr>
                      ...
                      <form action="../gasto_r/gasto_reporte_xls.php" method="post" target="_blank" id="for_rep_xls">
