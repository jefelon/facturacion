...
$dts1=$oCompra->mostrar_filtro(fecha_mysql($_POST['txt_fil_com_fec1']),fecha_mysql($_POST['txt_fil_com_fec2']),$_POST['cmb_fil_pro_id'],$_POST['cmb_fil_com_est']);
	...
	*****************************************************/
	...
	if($num_rows>=1)
	{
		...
		//{
			...
			$data[2]['TEXT'] = utf8_decode($dt1['tb_compra_numdoc']);
			$data[3]['TEXT'] = utf8_decode($dt1['tb_proveedor_nom']);
			$data[4]['TEXT'] = utf8_decode($dt1['tb_proveedor_doc']);
			
			$data[5]['TEXT'] = $dt1['tb_compra_subtot'];
			$data[5]['T_ALIGN'] = 'R';
			
			$data[6]['TEXT'] = $dt1['tb_compra_igv'];
			$data[6]['T_ALIGN'] = 'R';
			
			$data[7]['TEXT'] = $dt1['tb_compra_tot'];
			$data[7]['T_ALIGN'] = 'R';
			
			$data[8]['TEXT'] = $dt1['tb_compra_est'];
			$data[8]['T_ALIGN'] = 'R';
		...
		$data = Array();
			...
			$data[5]['TEXT'] = formato_money($total_subtot);
			$data[5]['T_SIZE'] = 7;
			$data[5]['T_ALIGN'] = 'R';
			$data[5]['V_ALIGN'] = "M";
			...
			$data[7]['TEXT'] = formato_money($total_compras);
			$data[7]['T_SIZE'] = 7;
			$data[7]['T_ALIGN'] = 'R';
			$data[7]['V_ALIGN'] = "M";
