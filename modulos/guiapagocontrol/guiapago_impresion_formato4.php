...
<table border="<?php echo $borde_tablas?>" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td style="width:121mm; " colspan="2">
        <table style="border: 1px solid #000;">
          <tr>
            <td style="width:45mm; height:5mm; font-size: 13pt; text-align:center;" valign="middle"><?php echo $numrucarr?></td>
          </tr>
        </table>
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <table style="border: 1px solid #000;">
          <tr>
            <td style="width:40mm; height:5mm; font-size: 13pt; text-align:center;" valign="middle"><?php echo $cli_doc?></td>
          </tr>
        </table>
      </td>
    </tr>
