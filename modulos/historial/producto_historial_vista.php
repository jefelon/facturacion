...
function seleccionar_producto(){	
	$.ajax({
		type: "POST",
		url: "../catalogo/catalogo_seleccionar_producto.php",
		async:true,
		dataType: "html",                      
		data: ({
			//action: act,
...
function consultar_producto_historial(idc){
	$.ajax({
		type: "POST",
		url: "../historial/producto_historial.php",
		async:true,
		dataType: "html",                      
		data: ({
			//action: act,
		...
		beforeSend: function() {
			//$('#msj_venta').hide();
			//$('#div_historial_producto_tabla').dialog("open");
...
function historial_tabla(){
	$.ajax({
		type: "POST",
		url: "../historial/producto_historial_tabla.php",
		async:true,
		dataType: "html",                      
		data: ({
		...
		beforeSend: function() {
			$('#div_historial_tabla').html('Cargando <img src="../../images/loadingf11.gif" align="absmiddle"/>');
			//$('#div_catalogo_venta_tabla').addClass("ui-state-disabled");
    },
		success: function(html){			
			$('#div_historial_tabla').html(html);
		},
		complete: function(){			
...
$(function() {
	...
	/*$( "#div_seleccionar_producto" ).dialog({
    	...
    	<div class="contenido">
            ...
            <table align="center" class="tabla_cont">
                  ...
                  <tr>
                    ...
                    <tr>
                      <td width="25" align="left" valign="middle"><a id="btn_seleccionar" href="#" onClick="seleccionar_producto()">Seleccionar</a></td>
