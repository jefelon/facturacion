...
require_once("../formatos/formato.php");
	...
	$archivo_destino='../ingreso/ingreso_impresion_recibo.php';
...
{	
	$("#for_preimp").submit();
	$('#div_ingreso_impresion').dialog('close');
}
/*
...
<input name="ing_id" id="ing_id" type="hidden" value="<?php echo $_POST['ing_id']?>">
<br>
<div id="rad_formato">
...
<br>
	<div style="text-align:center">
        ...
        <a class="btn_canimp" href="#printc" onClick="$('#div_ingreso_impresion').dialog('close');">Cancelar</a>
    </div>
</form>
