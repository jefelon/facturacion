...
$dts= $oIngreso->mostrarUno($_POST['ing_id']);
  $dt = mysql_fetch_array($dts);
    ...
    $imp    =formato_money($dt['tb_ingreso_imp']);
...
$monto_letras=numtoletras($dt['tb_ingreso_imp']);
...
?>
    ...
    <page_footer style="font-family:<?php //echo $tipo_de_letra?>">
        <table border="<?php echo $borde_tablas?>">
            <tr>
                <td style="text-align: left; width: 50%; font-size: 7pt;"><?php //echo 'www.estudiovidalcontadores.com' //echo 'Registrado: '.date('H:i:s d/m/Y', strtotime($fecreg)); ?></td>
...
<table border="<?php echo $borde_tablas?>" cellspacing="0" cellpadding="0" style="width: 80mm;">
  ...
  <tr>
    ...
    <td valign="top" style="font-size: 8pt;"><?php echo 'RUC '.$cli_doc?></td>
  </tr>
  <tr>
...
<table border="<?php echo $borde_tablas?>" cellspacing="0" cellpadding="0" style="width: 80mm;">
  <tr>
    <td valign="top" style="width:64mm; font-size: 7pt; height:5mm;"><?php echo 'RECIBÍ CONFORME'?></td>
    <td valign="top" style="width:64mm; font-size: 7pt;"><?php echo 'V°B°'?></td>
  </tr>
  <tr>
