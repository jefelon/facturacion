...
function ingreso_tabla()
{
	$.ajax({
		...
		beforeSend: function() {
			$('#msj_ingreso_tabla').html("Cargando...");
			$('#msj_ingreso_tabla').show(100);
...
function ingreso_reporte(url)
{	
	$("#for_fil_ing").attr("action", url);
	$("#for_fil_ing").submit();
}
    ...
    <article class="content">
    	<div class="contenido">
            ...
            <table align="center" class="tabla_cont">
                  <tr>
                    <td class="caption_cont">INGRESOS - CAJA</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <tr>
                      ...
                      <td align="left" valign="middle"><a class="btn_imprimir_pdf" id="btn_imprimir_pdf" href="#" onClick="ingreso_reporte('ingreso_reporte.php')" title="Imprimir en Pdf">Pdf</a></td>
                      <td width="6%" align="left" valign="middle">
                      <a class="btn_imprimir_xls" id="btn_imprimir_xls" href="#" onClick="ingreso_reporte_xls()" title="Imprimir en Excel">Excel</a>
                      <form action="ingreso_reporte_xls.php" method="post" target="_blank" id="for_rep_xls">
                      ...
                      <div id="msj_ingreso_tabla" class="ui-state-highlight ui-corner-all" style="width:auto; float:right; padding:2px; display:none"></div>
                      </td>
                    </tr>
                  </table>
                    </td>
