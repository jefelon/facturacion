...
class cIngreso{
	...
	$sql="SELECT DISTINCT(tb_ingreso_des) FROM tb_ingreso
	WHERE tb_empresa_id=$emp
	...
	function mostrar_suma($emp_id,$fec1,$fec2,$cue_id,$subcue_id,$doc,$cli_id,$entfin_id,$est,$caj_id,$mon_id,$ref_id){
