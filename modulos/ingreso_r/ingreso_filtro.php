...
<form name="for_fil_ing" id="for_fil_ing" target="_blank" action="<?php echo $_POST['../ingreso - Copia/act']?>" method="post">
<fieldset><legend>Filtro de Ingresos</legend>
    ...
    <?php /*?><label for="cmb_fil_ref_id">Referencia:</label>
