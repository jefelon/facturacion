...
<div style="width: 100%;margin: 0 auto">
    ...
    <fieldset style="width: 100%;float: left"><legend>Descargar EXCEL</legend>
        ...
        <select name="cmb_fil_librople" id="cmb_fil_librople">
            ...
            <option value="080100">Registro de Compras 080100 - COMPLETO</option>
            <option value="140100">Registro de Ventas 140100 - COMPLETO</option>
        </select>
        <br/>

        <a href="#" onClick="descargar_excel()" id="btn_descargar_txt" class="center">DESCARGAR EXCEL</a>
    </fieldset>
</div>
