...
<table border="0" cellspacing="2" cellpadding="2" class="ui-widget ui-widget-content">
		<thead>    	
			<tr class="ui-widget-header">
				...
				<th>N° DOCUMENTO</th>
				<th title="CAMBIO">CAMBIO</th>
				<th title="UTILIDAD">UTIL%</th>
        ...
        <?php
			while($dt1 = mysql_fetch_array($dts1)){
				if($dt1['tb_tipoperacion_id']==1){
					$sum_can_salini += $dt1['tb_notalmacendetalle_can'];
				?>
				<tr>
					<td><?php echo mostrarFecha($dt1['tb_notalmacen_fec'])?></td>
					<td><?php echo $dt1['tb_documento_nom']?></td>
                    <td><?php echo $dt1['tb_notalmacen_cod']?></td>
                    <td align="right"><?php echo formato_money($cat_tipcam)?></td>
                    <td align="right"><?php echo formato_money($cat_uti)?></td>
					...
					<td align="center"><a class="btn_editar_si" href="#update" onClick="notalmacen_detalle_form('editar','<?php echo $dt1['tb_notalmacendetalle_id']?>')">Editar</a></td>
				</tr>
			<?php
				}
