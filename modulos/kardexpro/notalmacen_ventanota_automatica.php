<?php
	...
	$dts = $oVentanota->mostrar_todos_por_empresa($_SESSION['empresa_id'],$alm_id);
	...
	while($dt = mysql_fetch_array($dts)){			
		...
		$oNotalmacen->insertar(1, $codigo, $ven_fec, 2, $doc_id, $doc_num, 3, 'NOTA DE VENTA', $ven_id, $alm_id, 2, $_SESSION['empresa_id']);		
		...
		$rs_2 = $oVentanota->mostrar_venta_detalle($ven_id);
