...
<form name="for_fil_let" id="for_fil_let" target="_blank" action="letra_reporte.php" method="post">
<input name="hdd_modo" id="hdd_modo" type="hidden" value="letra_tabla.php">
<fieldset><legend>Filtro de Letras</legend>
...
<!--    <label for="chk_ven_anu" title="Activar para anular venta.">Anular Venta<input name="chk_ven_anu" id="chk_ven_anu" type="checkbox" value="1"></label>-->
  	<a href="#" onClick="letra_tabla()" id="btn_filtrar">Filtrar</a>
    <a href="#" onClick="letra_filtro()" id="btn_resfil">Restablecer</a>
</fieldset>
</form>