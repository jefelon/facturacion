...
while ($fila = mysql_fetch_array($rs)){
    array_push($arrayElementos, new ElementoAutocompletar($fila["tb_lote_id"], $fila["tb_lote_numero"].' - '.$fila["tb_lote_fechavence"] .' - '.$fila['tb_lote_exisact'],$fila["tb_lote_numero"], $fila["tb_lote_fechafab"],$fila["tb_lote_fechavence"], $fila['tb_lote_exisact']));
}
