...
$dts=$oCompraDetalleLote->mostrar_filtro_compra_detalle( $_POST['comdet_id']);
...
$(function() {
	...
	$("#tabla_lote").tablesorter({
		...
		?>  
            ...
            ?>
                <tr>
                    <td><?php echo $dt['tb_compradetalle_lotenum']?></td>
                    <td><?php echo $dt['tb_fecha_fab']?></td>
                    <td><?php echo $dt['tb_fecha_ven']?></td>
                    <td><?php echo $dt['tb_compradetalle_exisact']?></td>
                </tr>
			<?php
				}
