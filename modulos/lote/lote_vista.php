...
{	
	$.ajax({
		...
		beforeSend: function() {
			$('#div_lote_tabla').addClass("ui-state-disabled");
        },
		success: function(html){
			$('#div_lote_tabla').html(html);
		},
		complete: function(){			
			$('#div_lote_tabla').removeClass("ui-state-disabled");
		}
	});     
}

function lote_form(act,idf)
{
	$.ajax({
		type: "POST",
		url: "lote_form.php",
    ...
    <article class="content">
    	<div class="contenido">
            ...
            <table align="center" class="tabla_cont">
                  <tr>
                    <td class="caption_cont">LOTES</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <tr>
                      <td width="25" align="left" valign="middle"><a id="btn_agregar" href="#" onClick="lote_form('insertar')">Agregar</a></td>
                      <td width="25" align="left" valign="middle"><a id="btn_actualizar" href="#">Actualizar</a></td>
                      <td align="left" valign="middle">&nbsp;</td>
                      <td align="right"><div id="msj_lote" class="ui-state-highlight ui-corner-all" style="width:auto; float:right; padding:2px; display:none"></div></td>
                    </tr>
                  </table>
                    </td>
                  </tr>
        	...
        	<div id="div_lote_tabla" class="contenido_tabla">
      		</div>
      	</div>
    </article>
</div>
