...
class cNotacredito{
	...
	$sql = "INSERT INTO tb_notacredito(
	`tb_venta_reg` ,
	`tb_venta_fec` ,
	`tb_documento_id` ,
	`tb_venta_numdoc` ,
	...
	$sql = "INSERT INTO tb_notacreditodetalle(
	...
	INNER JOIN tb_notacreditodetalle vd ON v.tb_venta_id = vd.tb_venta_id
	...
	$sql="SELECT * FROM tb_notacredito
	...
	INNER JOIN tb_notacreditodetalle vd ON ct.tb_catalogo_id = vd.tb_catalogo_id
	...
	INNER JOIN tb_notacreditodetalle vd ON vd.tb_servicio_id = s.tb_servicio_id
	WHERE vd.tb_venta_id=$ven_id ";
	$oCado = new Cado();
	$rst=$oCado->ejecute_sql($sql);
	return $rst;
