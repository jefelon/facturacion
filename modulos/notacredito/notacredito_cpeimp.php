...
<table style="font-size:7pt" border="0">
    <tr>
        ...
        <td width="400">AV. AUGUSTO B. LEGUÍA N° 1160 URB. SAN LORENZO J. L. ORTIZ - CHICLAYO - LAMBAYEQUE</td>
    </tr>
    <tr>
        <td></td>
...
<table style="width: 50%; border: 0.5px solid #eeeeee; border-collapse:collapse;">';
    ...
    <tr class="row">
        ...
        <td width="25%" style="text-align: left;">Doc. Vinculado:</td>
        <td width="70%" style="text-align: left;">'.$vennumdoc.'</td>
    </tr>';
    ...
    <tr class="row">
        <td width="5%" style="text-align: left;">'.$num.')</td>
        <td width="25%" style="text-align: left;">Motivo:</td>
        <td width="70%" style="text-align: left;">'.$mot.'</td>
    </tr>';
