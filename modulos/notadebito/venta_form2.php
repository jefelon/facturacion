...
$(function() {
	...
	$('#txt_ven_ser, #txt_ven_mot, #txt_ven_det').change(function(){
 ...
 <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td>
        ...
        <select name="cmb_ven_tip" id="cmb_ven_tip">
        	...
        	<option value="2" selected="selected">AUMENTO EN EL VALOR</option>
        </select>
      </td>
      <td>
    ...
    <tr>
      <td colspan="2">
        ...
        <input name="txt_ven_mot" type="text" id="txt_ven_mot" style="font-size:14px"  value=""  size="60">
      </td>
    </tr>
    <tr>
      <td>&nbsp</td>
    ...
    <tr>
      <td colspan="3">
      	<label for="txt_ven_det">Ítem:</label>
        <input name="txt_ven_det" type="text" id="txt_ven_det" style="font-size:14px"  value=""  size="60">
        <label for="txt_ven_mon">Monto:</label>
        <input name="txt_ven_mon" type="text" id="txt_ven_mon" style="text-align:right; font-size:14px"  value="" maxlength="10" size="10" class="moneda">
      </td>
    </tr>
</table>
