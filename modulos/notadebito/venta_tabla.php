...
$dts1=$oNotadebito->mostrar_filtro(fecha_mysql($_POST['txt_fil_ven_fec1']),fecha_mysql($_POST['txt_fil_ven_fec2']),$_POST['cmb_fil_ven_doc'],$_POST['hdd_fil_cli_id'],$_POST['cmb_fil_ven_est'],$_SESSION['usuario_id'],$_SESSION['puntoventa_id'],$_POST['chk_fil_ven_may']);
	...
	$("#tabla_venta").tablesorter({
        ...
        ?>
                    <tr>
                      ...
                      <td><?php echo $dt1['tb_venta_mot']?></td>
                      ...
                      <td>
                      <?php
                        $cant = $oNotadebitocorreo->contar($dt1['tb_venta_id']);
