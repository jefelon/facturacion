...
$dts1=$oNotalmacen->mostrar_notalmacen_detalle($_POST['notalm_id']);
        ...
        <table cellspacing="1" id="tabla_notalmacen_detalle" class="tablesorter">
            <thead>
                <tr>
                  ...
                  <th>MARCA</th>
                  <th>CATEGORIA</th>
                  <?php /*?><th title="PRECIO COSTO">P. COSTO S/.</th>
                  <th title="PRECIO VENTA">P. VENTA S/.</th><?php */?>
                </tr>
            </thead>
			<?php
            if($num_rows>=1){
				...
				?>
                        <tr>
                          ...
                          <td><?php echo $dt1['tb_presentacion_cod']?></td>
							...
							?></td>
                            <?php /*?><td align="right"><?php echo formato_money($dt1['tb_notalmacendetalle_cos'])?></td>
                            <td align="right"><?php echo formato_money($dt1['tb_notalmacendetalle_pre'])?></td><?php */?>
                        </tr>
                <?php
                	}
