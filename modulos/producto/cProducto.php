...
class cProducto{
	...
	$sql = "INSERT INTO tb_producto(
		...
		VALUES (
		NOW( ) , NOW( ) ,  '$nom',  '$des',  '$est',  '$cat_id', '$mar_id',  '$usu_id', '$prod_img' ,'{$_SESSION['empresa_id']}'
		);"; 
	$oCado = new Cado();
	...
	WHERE p.tb_producto_id=$pro_id AND tb_compra_est='CANCELADA' AND p.tb_empresa_id={$_SESSION['empresa_id']}
