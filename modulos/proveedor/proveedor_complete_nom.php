...
while ($fila = mysql_fetch_array($rs)){
   array_push($arrayElementos, new ElementoAutocompletar($fila["tb_proveedor_id"], $fila["tb_proveedor_doc"].'-'.$fila["tb_proveedor_nom"],$fila["tb_proveedor_nom"], $fila['tb_proveedor_dir'], $fila['tb_proveedor_doc']));
}
