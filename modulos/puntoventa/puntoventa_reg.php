...
if($_POST['action_puntoventa']=="insertar")
{
	...
	{
		$oPuntoventa->insertar(strip_tags($_POST['txt_punven_nom']),$_POST['cmb_alm_id'],$_SESSION['empresa_id'],$_POST['txt_punven_dir']);
...
if($_POST['action_puntoventa']=="editar")
{
	if(!empty($_POST['txt_punven_nom']))
	{
		$oPuntoventa->modificar($_POST['hdd_punven_id'],strip_tags($_POST['txt_punven_nom']),$_POST['cmb_alm_id'],$_SESSION['empresa_id'],$_POST['txt_punven_dir']);
		echo 'Se registró punto de venta correctamente.';
	}
	else
	{
