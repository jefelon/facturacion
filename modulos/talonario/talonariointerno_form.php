...
{
	$dts=$oTalonariointerno->mostrarUno($_POST['tal_id']);
...
{	
	$.ajax({
		type: "POST",
		url: "../almacen/cmb_alm_id.php?ventas=1",
		async:true,
		dataType: "html",                      
		data: ({
...
$(function() {
	...
	$("#for_tal").validate({
		submitHandler: function() {
			$.ajax({
				type: "POST",
				url: "../talonario/talonariointerno_reg.php",
				async:true,
				dataType: "html",
...
<input name="hdd_tal_id" id="hdd_tal_id" type="hidden" value="<?php echo $_POST['tal_id']?>">
    <table>
        ...
        <select name="cmb_doc_id" id="cmb_doc_id">
          <option value="">-</option>
          <option value="1" <?php if($doc_id==1)echo 'selected'?>>NOTA DE VENTA</option>
          <option value="2" <?php if($doc_id==2)echo 'selected'?>>TRANSFERENCIA</option>
          <option value="3" <?php if($doc_id==3)echo 'selected'?>>NOTA DE ALMACEN</option>
        </select></td>
        </tr>
        <tr>
        ...
        <tr>
          <td align="right"><label for="cmb_alm_id">Almacén:</label></td>
          <td colspan="3"><select name="cmb_alm_id" id="cmb_alm_id">
          </select></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td colspan="3"><input type="text" name="txt_tal_ini" id="txt_tal_ini" class="cantidad" style="text-align:right" size="10" maxlength="6" value="<?php echo $ini?>">
            -
            <input type="text" name="txt_tal_fin" id="txt_tal_fin" class="cantidad" style="text-align:right" size="10" maxlength="6" value="<?php echo $fin?>"></td>
        </tr>
        <tr>
          <td align="right"><label for="txt_tal_num" title="Último utilizado">Número:</label></td>
          <td><input type="text" name="txt_tal_num" id="txt_tal_num" class="cantidad" style="text-align:right" size="10" maxlength="6" value="<?php echo $num?>"></td>
