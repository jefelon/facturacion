...
{	
	$.ajax({
		type: "POST",
		url: "talonariointerno_tabla.php",
		async:true,
		dataType: "html",                      
		data: ({
...
$(function() {
	...
	$( "#div_talonario_form" ).dialog({
		title:'Información de Talonario Interno',
		autoOpen: false,
		resizable: false,
		height: 240,
		width: 500,
    ...
    <article class="content">
    	<div class="contenido">
            ...
            <table align="center" class="tabla_cont">
                  <tr>
                    <td class="caption_cont">TALONARIO INTERNO</td>
                  </tr>
                  <tr>
