...
class cTransferencia{
	...
	VALUES (
	NOW( ) ,NOW( ) ,  '$fec',  '$cod',  '$des',  '$mon', '$est',  '$caj_id_ori', '$caj_id_des', '$mon_id',  '$emp_id',  '$usu_id_reg', '$usu_id_mod'
	);"; 
	$oCado = new Cado();
	...
	$sql="SELECT DISTINCT(tb_transferencia_des) FROM tb_transferencia
	...
	$sql="SELECT tb_transferencia_id, tb_transferencia_reg, tb_transferencia_mod, tb_transferencia_fec, tb_transferencia_cod, tb_transferencia_des, tb_transferencia_mon, tb_transferencia_est, co.tb_caja_nom AS caja_ori, cd.tb_caja_nom AS caja_des, tb_moneda_id
