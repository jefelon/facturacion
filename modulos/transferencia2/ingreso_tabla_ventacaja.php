...
$dts1=$oIngreso->mostrar_filtro_fec($emp_id,fecha_mysql($_POST['txt_fil_ing_fec1']),fecha_mysql($_POST['txt_fil_ing_fec2']),$_POST['cmb_fil_cue_id'],$_POST['cmb_fil_subcue_id'],$_POST['txt_fil_ing_doc'],$_POST['cmb_fil_cli_id'],$_POST['cmb_fil_entfin_id'],$_POST['cmb_fil_ing_est'],$_POST['cmb_fil_caj_id'],$_POST['cmb_fil_ref_id']);
