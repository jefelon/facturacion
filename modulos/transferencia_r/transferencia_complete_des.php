...
require_once ("../transferencia_r/cTransferencia.php");
...
while ($fila = mysql_fetch_array($rs)){
   array_push($arrayElementos, new ElementoAutocompletar($fila["tb_transferencia_des"], $fila["tb_transferencia_des"]));
}
