...
<form name="for_fil_tra" id="for_fil_tra" target="_blank" action="<?php echo $_POST['../transferencia - Copia/act']?>" method="post">
<fieldset><legend>Filtro de Transferencias</legend>
    ...
    <input name="txt_fil_tra_cod" type="text" id="txt_fil_tra_cod" size="15" maxlength="15">

    <?php /*?><label for="cmb_fil_cli_id">Cliente:</label>
	<select name="cmb_fil_cli_id" id="cmb_fil_cli_id">
    </select><?php */?>
    
    <label for="cmb_fil_caj_id_ori">Caja Origen:</label>
    <select name="cmb_fil_caj_id_ori" id="cmb_fil_caj_id_ori">
    </select>
    
    <label for="cmb_fil_caj_id_des">Caja Destino:</label>
