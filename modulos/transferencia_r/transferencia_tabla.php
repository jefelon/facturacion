...
<table cellspacing="1" id="tabla_transferencia" class="tablesorter">
        ...
        <tr>
          ...
          <th>CODIGO</th>
          <th>DESCRIPCION</th>
          <th>CAJA GENERAL ORIGEN</th>
          <th>CAJA TERCERO DESTINO</th>
          <th title="REFERENCIA">REF</th>
          <th title="ENTIDAD FINANCIERA">ENT. FINANC.</th>
          <th title="MODO">MODO</th>
...
?>
        <tr>
          ...
          <td><?php echo $dt1['tb_transferencia_modpag']?></td>
