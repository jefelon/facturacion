...
$url_web		=$d_dominio;
$url_web_sis	=$d_dominio_app;
$email_soporte	=$d_email_soporte;
$email_respuesta=$d_email_soporte;
...
if($_POST['action_usuario'] == 'insertar'){
	if($_POST['txt_use']!="" and $_POST['txt_pas']!="" and $_POST['txt_ema']!="" and $_POST['txt_apepat']!="" and $_POST['txt_apemat']!="" and $_POST['txt_nom']!="")
	{
		...
		else
		{
			...
			$aviso1="Se registró correctamente al usuario: ".$_POST['txt_use'].".";
	...
	{
		echo "0-No se pudo registrar Faltan Datos.";	
	}
}
...
if($_POST['action_usuario'] == 'editar'){
	if(!empty($_POST['hdd_usu_id']) and $_POST['txt_ema']!="" and $_POST['txt_apepat']!="" and $_POST['txt_apemat']!="" and $_POST['txt_nom']!="")
	{
		...
		//agregando punto de venta
		$cst1 = $oPuntoventa->mostrar_puntoventa_por_usuario($_POST['hdd_usu_id'],$_POST['cmb_punven_id']);
		...
		{
			$oPuntoventa->insertar_usuariopv($_POST['hdd_usu_id'],$_POST['cmb_punven_id']);
		}
			
		echo "0-Se registró usuario correctamente.";
	}
	else{
