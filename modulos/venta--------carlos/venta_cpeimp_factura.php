...
$params = $pdf->serializeTCPDFtagParameters(array($ruc_empresa.'|'.$tipdoc.'|'.$serie.'|'.$numero.'|'.$toigv.'|'.$importetotal.'|'.mostrarfecha($fecha).'|'.$tipdoccli.'|'.$ruc.'|', 'QRCODE,Q', '', '', 40, 40, $style, 'N'));
