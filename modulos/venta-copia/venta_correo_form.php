...
if($_POST['action']=='enviar')
{
	...
	if($doc_nom=='FACTURA ELECTRONICA')$mentip.='<a style="color: blue;" target="_blank" href="http://www.granadosllantas.com/facturacion/recursos/venta/venta_cpeimp_factura.php?id_doc='.md5($key.$_POST['ven_id']).'">Descargar PDF</a><br/>';

	if($doc_nom=='BOLETA ELECTRONICA')$mentip.='<a style="color: blue;" target="_blank" href="http://www.granadosllantas.com/facturacion/recursos/venta/venta_cpeimp_boleta.php?id_doc='.md5($key.$_POST['ven_id']).'">Descargar PDF</a><br/>';

	$mentip.='<a style="color: blue;" target="_blank" href="http://www.granadosllantas.com/facturacion/recursos/venta/descargar_xml.php?id_doc='.md5($key.$_POST['ven_id']).'">Descargar XML</a><br/>';
	
	//$link='<a style="color: blue;" target="_blank" title="Imprimir Guía de Pago" href="http://www.estudiovidalcontadores.com/app/recursos/guiapago/guiapago_impresion_formato1.php?d1='.$dt1['tb_guiapago_id'].'&d2='.$dt1['tb_cliente_id'].'">Imprimir</a>';
	...
	<table align="left" border="0" cellpadding="1" cellspacing="1" style="width:100%">
		<tbody>
			<tr>
				<td style="width:20%"><img alt="Logo" src="http://www.granadosllantas.com/facturacion/images/logo.jpg" /></td>
				<td style="width:80%">
				Sitio Web <a href="http://www.granadosllantas.com/portal/" target="_blank">www.granadosllantas.com</a>
				</td>
			</tr>
		</tbody>
	</table>';
