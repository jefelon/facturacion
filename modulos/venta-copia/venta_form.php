...
function venta_car(act,idf){
	if(act=='agregar')
	{
		...
		// if($('#txt_cat_preven_'+idf).autoNumericGet()>0)
		// {
			var precio=$('#txt_cat_preven_'+idf).autoNumericGet()-$('#hdd_cat_cospro_'+idf).autoNumericGet();
		// }
		// else
		// {
		// 	var precio=0;
	...
	else
	{
		...
		if(precio<0)
		{
			...
			$('#txt_cat_preven_'+idf).autoNumericSet($('#hdd_cat_cospro_'+idf).autoNumericGet());
		}
		else
		{
