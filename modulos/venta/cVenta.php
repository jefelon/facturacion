...
class cVenta{
    ...
    function insertar_tipo_venta($fec,$doc_id,$numdoc,$ser,$num,$cli_id,$valven,$igv,$des,$tot,$est,$lab1,$lab2,$lab3,$may,$usu_id,$punven_id,$emp_id,
                      $tipdoc,$tipmon,$gra,$ina,$exp,$grat,$isc,$otrtri,$otrcar,$desglo,$tipope,$docrel,$use_id,$tipo_venta,$tdes){
        $sql = "INSERT INTO tb_venta(
	`tb_venta_reg` ,
	`tb_venta_fec` ,
	`tb_documento_id` ,
...
WHERE tb_software_id =$id";
    ...
    function mostrar_manifiesto($vh_id)
    {
        ...
        ORDER  BY vv.tb_asiento_nom ASC
        ";
        $oCado = new Cado();
        $rst=$oCado->ejecute_sql($sql);
        return $rst;
