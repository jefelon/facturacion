<?php
class cVenta{
	function insertar($fec,$fec_ent,$doc_id,$numdoc,$ser,$num,$cli_id,$valven,$igv,$des,$tot,$est,$tipven,$lab1,$lab2,$lab3,$may,$usu_id,$punven_id,$emp_id,
	...
	VALUES (
	NOW( ) ,  '$fec', '$fec_ent', '$doc_id',  '$numdoc', '$ser',  '$num',  '$cli_id',  '$valven',  '$igv', '$des',  '$tot',  '$est', '$tipven', '$lab1', '$lab2', '$lab3', '$may',  '$usu_id', '$punven_id', '$emp_id',
	'$tipdoc', '$tipmon', '$gra', '$ina', '$exp', '$grat', '$isc', '$otrtri', '$otrcar', '$desglo', '$tipope','$docrel','$use_id'
	);"; 
	$oCado = new Cado();
