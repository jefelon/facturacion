...
if($num_rows>0){
    ...
    {
        $largo=55;
        $codigo=$fila["tb_presentacion_cod"];
        ...
        $etiqueta= '<span style="display:inline-block; width:250px;">'.$codigo.' - '.$producto.'</span><span style="display:inline-block; width:100px;">'.$marca.'</span><span style="display:inline-block; width:50px;text-align:right;">'.$stock." ".$fila["tb_unidad_abr"].'</span><span style="display:inline-block; width:100px;text-align:right;">'.$precio;
        array_push($arrayElementos, new ElementoAutocompletar($etiqueta, $codigo,$fila["tb_catalogo_id"]));
    }
}else{
