...
$dts0=$oCatalogo->filtrar_unidades_codigo($_POST['cat_id'],$_POST['txt_bus_pro_nom'],$_POST['txt_bus_pro_codbar'],$est,$_SESSION['almacen_id'],$lim);
...
///arreglar el buscar
	if($num_rows==1)
	{	
		$dts1=$oCatalogo->filtrar_unidades_codigo($_POST['cat_id'],$_POST['txt_bus_pro_nom'],$_POST['txt_bus_pro_codbar'],$est,$_SESSION['almacen_id'],$lim);
	...
	if($num_rows>1)
	{
		...
		//unidad
		$dts2=$oCatalogo->filtrar_unidades($_POST['txt_bus_pro_nom'],$_POST['txt_bus_pro_codbar'],$est,$_SESSION['almacen_id'],$lim);
