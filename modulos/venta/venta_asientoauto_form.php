    ...
    $(function () {
        ...
        $("#bus_form").validate({
            ...
            submitHandler: function () {
                ...
                if($('#txt_cli_dni').val()==""){
                    alert('Escriba el DNI o RUC del cliente y presione ENTER');
                    $('#txt_cli_dni').focus();
                    return false;
                }
                if($('#txt_cli_nom').val()==""){
...
<form id="bus_form">
    ...
    <div id="origen_destino">
        <fieldset><legend>Seleccionar Origen y Destino</legend>
            ...
            <table border="0" cellspacing="2" cellpadding="0">
                <tr>
                    <td>
                        <p style="padding-left:0;padding-right: 0">
                            ...
                            <label for="cmb_salida_id">Parada</label>
                ...
                <tr>
                    <td>
                        <label for="txt_fech_sal">F. Salida</label>
                        <input type="text" name="txt_fech_sal" id="txt_fech_sal" value="<?php echo $fec; ?>" style="width: 150px">

                        <label for="txt_hor_sal">Hora Salida:</label>
                        <input type="text" name="txt_hor_sal" id="txt_hor_sal"  value="<?php echo $hor; ?>" style="width: 75px">

                        <label for="txt_precio">Precio:</label>
                        <input class="venpag_moneda__" name="txt_precio" size="3" type="text" id="txt_precio">
                        <label for="txt_num_asi">Nro Asiento:</label>
                        <input class="venpag_moneda__" name="txt_num_asi" size="3" type="text" id="txt_num_asi">
                    </td>
                </tr>
            </table>
        </fieldset>
    ...
    <div>
        <div class="otros-datos" style="width: 60%;margin: 0 auto;margin-top: 10px;font-size: 11pt">
            <span for="" id="msj_busqueda_sunat" style="position: absolute;left:20px; top:110px; color: #00aa00"></span>
            <div id="documento">
