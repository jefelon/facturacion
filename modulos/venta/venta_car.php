...
<script type="text/javascript">
    ...
    $('#txt_com_destotal').change(function(e) {
        if (parseFloat($('#txt_ven_subtot').val())===parseFloat('0')){
            $('#txt_ven_des').val(parseFloat('0').toFixed(2));
        }else{
            $('#txt_ven_des').val(parseFloat((parseFloat($('#txt_com_destotal').val())*100)/parseFloat($('#txt_ven_subtot').val())).toFixed(2));
            venta_car_prorrateo();
        }
    });
    ...
    <tr>
            ...
            <div id="div_calcular_vuelto">
                <fieldset><legend>Aplicar a filas</legend>
                    <table>
                            ...
                            <td align="right"><input name="txt_com_destotal" type="text" id="txt_com_destotal" style="text-align:right; font-size:14px;" value="<?php echo formato_money($descuento_total)?>" size="15"></td>
        ...
        <td valign="top">
            <div style="margin-right:53px; margin-top:10px;">
                <table>
                    <tr>
                        <td align="right"><input name="txt_ven_subtot" type="hidden" id="txt_ven_subtot" style="text-align:right; font-size:14px" value="<?php echo formato_money($sub_total)?>" size="15" readonly></td>
                    </tr>
                    <tr>
                        <td align="right"><input name="txt_ven_desglob" type="hidden" id="txt_ven_desglob" style="text-align:right; font-size:14px;" value="<?php echo formato_money($descuento_global)?>" size="15" readonly></td>
                    </tr>
                    <tr>

                    </tr>
                    <tr>
                        <td align="right"><input name="txt_ven_opegra" type="hidden" id="txt_ven_opegra" style="text-align:right; font-size:14px" value="<?php echo formato_money($ope_gratuitas_total)?>" size="15" readonly>
                        </td>
                    </tr>
                </table>
            </div>
        ...
        <td valign="top">
            <div style="margin-right:53px; margin-top:10px;">
                <table border="0" align="right" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td align="right"><input name="txt_ven_opeexo" type="hidden" id="txt_ven_opeexo" style="text-align:right; font-size:14px" value="<?php echo formato_money($ope_exoneradas_total)?>" size="15" readonly>
                        </td>
                    </tr>
                    <tr>
