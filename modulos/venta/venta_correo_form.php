...
if($_POST['action']=='enviar')
{
	...
	if($doc_nom=='FACTURA ELECTRONICA')$mentip.='<a style="color: blue;" target="_blank" href="'.$d_documentos_app.'venta_cpeimp_factura.php?id_doc='.md5($key.$_POST['ven_id']).'">Descargar PDF</a><br/>';

	if($doc_nom=='BOLETA ELECTRONICA')$mentip.='<a style="color: blue;" target="_blank" href="'.$d_documentos_app.'venta_cpeimp_boleta.php?id_doc='.md5($key.$_POST['ven_id']).'">Descargar PDF</a><br/>';

	$mentip.='<a style="color: blue;" target="_blank" href="'.$d_documentos_app.'descargar_xml.php?id_doc='.$_POST['ven_id'].'">Descargar XML</a><br/>';
