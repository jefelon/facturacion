    ...
    <page id="contenido_pdf" <?php echo $pager_formato?> <?php echo $pager_margen?>>
        ...
        <?php if($impresion=='pdf' or $impresion=='html'){?>
            ...
            <table width="80mm">
                ...
                <!-- <tr> -->
                <!-- <td style="width: 88mm;"> -->
                <!-- <img src="<?php// echo $empresa_logo ?>" alt=""> -->
                <!-- </td> -->
                <!-- </tr> -->
                <tr>
                ...
                <tr>
                    <td colspan="2" class="izquierda">FECHA: <?php echo $fec ?></td>
                    <td colspan="2" class="derecha">N°: <?php echo $serie.' - '.$numero?></td>
                </tr>
                <tr>
                    <td colspan="4" height="10mm">.............................................................................................</td>
                </tr>
                <tr >
                    <td colspan="4"> <?php echo 'CLIENTE: ' .$cli_nom?></td>
                </tr>
                <tr>
                    <td colspan="4"> <?php echo 'DIRECCIÓN:' .$cli_dir?></td>
                </tr>
                <tr>
                    <td colspan="4"> <?php echo 'DNI: '.$cli_doc ?></td>
                </tr>
                <tr>
                    <td colspan="4">FORMA DE PAGO: <?php if($num_rows_vp==1)echo $texto_pago1[0]?></td>
                </tr>
                <tr>
                    <td colspan="4" height="10mm">.............................................................................................</td>
                </tr>
