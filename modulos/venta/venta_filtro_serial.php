...
<center>
    ...
    <label for="txt_fil_numdoc" align="left">Número de Documento:</label>
    <input type="text" id="txt_fil_numdoc" name="txt_fil_numdoc" size="20" placeholder="Ingrese Nro. de Documento" value="<?php echo $_POST['numdoc']?>" />
