...
if($_POST['action']=="editar"){
	...
	$dt = mysql_fetch_array($dts);
		...
		$fec	=mostrarFechaHora($dt['tb_venta_fec']);
        $fec_ent=mostrarFechaHora($dt['tb_ventafec_ent']);
...
$("#txt_ven_fec, #txt_venfec_ent").flatpickr(optional_config);
...
jQuery.validator.addMethod("equalOr", function(value, element, parameter) {
           return $(parameter).val() === value || $(parameter).val() === '15' || $(parameter).val() === '19';
...
function txt_ven_numdoc(){
	$.ajax({
		...
		beforeSend: function() {
            ...
            if($('#cmb_ven_doc').val()*1==19)//nota de salida
            {
                $('#hdd_val_cli_tip').val('19');
            }
        },
...
<fieldset>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
          <td style="width:85%;"><label for="txt_ven_fec">Fecha Pedido:</label>
              <input id="txt_ven_fec" name="txt_ven_fec" class="timepicker" size="20"
                     value="<?php echo $fec ?> maxlength=" 20"/>
              ...
              <input name="txt_ven_numdoc" type="text" id="txt_ven_numdoc" style="text-align:right; font-size:14px"
                     value="<?php echo $ser . '-' . $num ?>" size="10" readonly>
          </td>
      <td align="right">
      <?php
      if($_POST['action']=="editar")
    ...
    <tr>
      <td height="27">
          <label for="txt_venfec_ent">Fecha Entrega:</label>
          <input id="txt_venfec_ent" name="txt_venfec_ent" class="timepicker" size="20"
                 value="<?php echo $fec_ent ?>" maxlength="20"/>
          <label for="cmb_tipventa_id">Tipo</label>
          <select name="cmb_tipventa_id" id="cmb_tipventa_id">
              <option value="1" <?php if($tip_ven=='1') echo 'selected'?>>BORDADO</option>
              <option value="2" <?php if($tip_ven=='2') echo 'selected'?>>SUBLIMADO</option>
              <option value="3" <?php if($tip_ven=='3') echo 'selected'?>>CONFECCIÓN</option>
              <option value="4" <?php if($tip_ven=='4') echo 'selected'?>>VENTA DE ARTICULO</option>
              <option value="5" <?php if($tip_ven=='5') echo 'selected'?>>HOJAL Y BOTON</option>
          </select>
        ...
        <input type="hidden" name="txt_ven_lab3" id="txt_ven_lab3" value="<?php echo $lab3?>" size="20" maxlength="20">
        <input name="hdd_ven_doc" id="hdd_ven_doc" type="hidden" value="">
        <br>
        <input name="chk_ven_may" type="hidden" id="chk_ven_may" value="1">
        </td>
      <td align="right">
      <?php
      if($_POST['action']=="insertar" || $_POST['action']=="insertar_cot"){
...
<fieldset>
    ...
    <fieldset><legend>Agregar Producto</legend>
        ...
        <input type="hidden" name="txt_detcom_des" id="txt_detcom_des" class="moneda" value="<?php echo formato_money(0.00)?>" size="6" maxlength="5" style="text-align:right" >
        ...
        <input type="hidden" name="txt_precio_min" id="txt_precio_min" size="10" readonly>

        <input type="hidden" name="txt_precio_may" id="txt_precio_may" size="10" readonly>

        <input type="hidden" id="che_mayorista" style="margin-top: 5px;" value="0">
