  ...
  <tr>
    <td colspan="2" style="width: 100mm; vertical-align:top">
        ...
        <tr>
          ...
          <td style="width:20mm; font-size: 10pt;">&nbsp;</td>
          <td style="width:20mm; height:6mm; text-align:right; font-size: 10pt;"><?php echo $fec?></td>
        </tr>
        <tr>
        ...
        <td colspan="2" style="width: 45mm; height:6mm; text-align:right; font-size: 10pt;"><?php if($num_rows_vp==1)echo $texto_pago1[0]?></td>
        </tr>
        </table>
    </td>
  </tr>
