...
<input name="hdd_modo" id="hdd_modo" type="hidden" value="venta_manifiesto_tabla_enc.php">
<fieldset><legend>Filtro de Manifiesto</legend>
    ...
    <label for="txt_fil_cho">Chofer:</label>
    <input type="text" id="txt_fil_cho" name="txt_fil_cho" size="40" />

    <label for="txt_fil_pla">Placa:</label>
    <input type="text" id="txt_fil_pla" name="txt_fil_pla" size="10" />
