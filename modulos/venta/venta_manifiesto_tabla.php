...
$dts1=$oVenta->mostrar_filtro_man(fecha_mysql($_POST['txt_fil_ven_fec1']),fecha_mysql($_POST['txt_fil_ven_fec2']),$_POST['hdd_fil_con_id'],$_POST['cmb_fil_ven_est'],$_POST['cmb_fil_ven_ven'],$_POST['cmb_fil_ven_punven'],$_SESSION['empresa_id']);
...
<table cellspacing="1" id="tabla_venta" class="tablesorter">
    ...
    if($num_rows>0){
        ...
        while($dt1 = mysql_fetch_array($dts1)){
            ?>
            <tr>
                <td nowrap="nowrap">MANIFIESTO DE PASAJEROS</td>
                <td nowrap="nowrap" align="center"><?php echo $dt1['tb_viajehorario_ser'].'-'.$dt1['tb_viajehorario_num']?></td>
