...
<?php
$dts1=$oVentapago->caja_filtro_adm(fecha_mysql($_POST['txt_fil_ven_fec1']),fecha_mysql($_POST['txt_fil_ven_fec2']),$_POST['cmb_fil_ven_doc'],$_POST['hdd_fil_cli_id'],$_POST['cmb_fil_ven_est'],$_POST['cmb_fil_ven_ven'],$_POST['cmb_fil_ven_punven'],$_SESSION['empresa_id'],0,0,0,0);
...
while($dt1 = mysql_fetch_array($dts1))
{
	...
	$glosa="VENTAS ".$dt1['tb_formapago_nom'].' '.$dt1['tb_modopago_nom'].' '.$dt1['tb_cuentacorriente_nom'].$dt1['tb_tarjeta_nom'];
...
?>
  <tr>
	...
	if($_POST['cmb_fil_ven_est']=='CANCELADA')
	{
		...
		{
	?>
    <a id="btn_agregar" title="Agregar" href="#reging" style="color:#039" onClick="ingreso_form('insertar','','caja','<?php echo $glosa?>','<?php echo $dt1['total']?>','<?php echo $ref_id?>','<?php echo $entfin_id?>')">Ingreso</a>
    <?php 
		}
	}
	else
...
<?php
$dts1=$oClientecuenta->caja_venta_filtro_adm(fecha_mysql($_POST['txt_fil_ven_fec1']),fecha_mysql($_POST['txt_fil_ven_fec2']),$_POST['cmb_fil_ven_doc'],$_POST['hdd_fil_cli_id'],$_POST['cmb_fil_ven_est'],$_POST['cmb_fil_ven_ven'],$_POST['cmb_fil_ven_punven'],$_SESSION['empresa_id'],0,0,0,0,2,2);
...
while($dt1 = mysql_fetch_array($dts1))
{
	...
	$glosa="VENTAS CREDITO | PAGO: ".$dt1['tb_formapago_nom'].' '.$dt1['tb_modopago_nom'].' '.$dt1['tb_cuentacorriente_nom'].$dt1['tb_tarjeta_nom'];
