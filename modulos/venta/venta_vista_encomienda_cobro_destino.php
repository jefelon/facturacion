...
<head>
    ...
    <script type="text/javascript">
        function venta_filtro()
        {
            $.ajax({
                type: "POST",
                url: "../venta/venta_filtro_encomienda_cobro_destino.php",
                async:true,
                dataType: "html",
                data: ({
                     ven_tip: 'ENCOMIENDA'
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    ...
                                    <td width="6%" align="left" valign="middle" nowrap>
                                        <a href="#" onClick="modo('venta_tabla_encomienda_cobro_destino.php')" class="btn_modo" title="Modo Vista Ventas">Ventas</a>
                                    </td>
