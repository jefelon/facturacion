		...
		complete: function(){
			if(act=='insertar')
			{
				$( "#div_venta_form" ).dialog({
					title:'Registrar Venta | <?php echo $_SESSION['empresa_nombre']. " - PV: ".$_SESSION['puntoventa_nom']." | A: ".$_SESSION['almacen_nom'];?>',
					height: 610,
					width: 980,
					buttons: {
						Guardar: function(){
...
$(function() {
	...
	$( "#div_venta_form" ).dialog({
		title:'Información de Venta | <?php echo $_SESSION['empresa_nombre']. "PV: ".$_SESSION['puntoventa_nom']." | A: ".$_SESSION['almacen_nom'];?>',
		autoOpen: false,
		resizable: false,
		height: 500,
		width: 980,
