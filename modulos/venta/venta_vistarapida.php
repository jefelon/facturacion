...
<!--    <script src="../../js/contextmenu/jquery.contextmenu.js"></script>-->
    ...
    <script type="text/javascript">
        ...
        function venta_asiento_form(act,idf){
            $.ajax({
                type: "POST",
                url: "../venta/venta_asientoauto_form.php",
                // url: "../venta/croquis.php",
                async:true,
                dataType: "html",
                data: ({
                    ...
                    <tr>
                        <td>
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td width="6%" align="left" valign="middle"><button id="btn_agregar" title="Agregar" href="#" onClick="venta_asiento_form()">Agregar</button></td>
