...
<input name="hdd_modo" id="hdd_modo" type="hidden" value="ventacanje_tabla_adm.php">
...
<?php */?>    <label for="cmb_fil_ven_punven">Punto Venta:</label>
...
<?php /*?>    <label for="chk_ven_anu" title="Activar para anular venta.">Anular<input name="chk_ven_anu" id="chk_ven_anu" type="checkbox" value="1"></label><?php */?>
  	<a href="#" onClick="ventacanje_tabla()" id="btn_filtrar">Filtrar</a>
    <a href="#" onClick="ventacanje_filtro()" id="btn_resfil">Restablecer</a>
</fieldset>
</form>