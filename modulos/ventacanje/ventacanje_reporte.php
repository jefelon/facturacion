...
//____
	...
	*****************************************************/
	...
	//$cat_id=40;
		...
		$dts1=$oVentanota->mostrar_filtro_detalle( fecha_mysql($_POST['txt_fil_ven_fec1']),fecha_mysql($_POST['txt_fil_ven_fec2']),$_POST['cmb_fil_ven_doc'],$tipo[$indice],$cat_ids,$_POST['hdd_fil_cli_id'],$_POST['cmb_fil_ven_est'],$_SESSION['usuario_id'],$_SESSION['puntoventa_id']);
		$num_rows= mysql_num_rows($dts1);
