...
<title>Notas de Venta - Canjeados</title>
...
function ventacanje_filtro()
{
	$.ajax({
		type: "POST",
		url: "../ventacanje/ventacanje_filtro_adm.php",
		async:true,
		dataType: "html",                      
		//data: ({
		...
		//}),
		beforeSend: function() {
			$('#div_ventacanje_filtro').html('Cargando <img src="../../images/loadingf11.gif" align="absmiddle"/>');
        },
		success: function(html){
			$('#div_ventacanje_filtro').html(html);
		},
		complete: function(){
			ventacanje_tabla();
		}
...
function ventacanje_tabla()
{
	$.ajax({
		...
		beforeSend: function() {
			$('#div_ventacanje_tabla').addClass("ui-state-disabled");
        },
		success: function(html){
			$('#div_ventacanje_tabla').html(html);
		},
		complete: function(){			
			$('#div_ventacanje_tabla').removeClass("ui-state-disabled");
		}
	});     
}
    ...
    <article class="content">
    	<div class="contenido">
            ...
            <table align="center" class="tabla_cont">
                  <tr>
                    <td class="caption_cont">NOTAS DE VENTA - CANJEADOS</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <tr>
                      ...
                      <?php /*?><td width="6%" align="left" valign="middle"><a class="btn_imprimir_pdf" id="btn_imprimir_pdf" href="#" onClick="ventanota_reporte('venta_reporte_adm.php')" title="Imprimir en Pdf">Pdf</a></td>
                      ...
                      <td width="6%" align="left" valign="middle"><a class="imprimir_pdf" id="btn_imprimir_pdf" href="#" onClick="ventanota_reporte('venta_reporte_detalle_adm.php')" title="Imprimir en Pdf">Reporte</a></td><?php */?>
        	...
        	<div id="div_ventacanje_filtro" class="contenido_tabla">
      		</div>
            ...
            <div id="div_ventacanje_tabla" class="contenido_tabla">
      		</div>
      	</div>
    </article>
</div>
