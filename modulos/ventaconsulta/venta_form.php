	...
	<table>
		<tr>
			...
			<td>
				...
				<input type="text" id="txt_ven_cli_nom" name="txt_ven_cli_nom" size="61" value="<?php echo $cli_nom?>" />
			</td>
		...
		<tr>
			...
			<td><input type="text" id="txt_ven_cli_dir" name="txt_ven_cli_dir" size="85" value="<?php echo $cli_dir?>" disabled="disabled"/></td>
		</tr>
		<tr>
