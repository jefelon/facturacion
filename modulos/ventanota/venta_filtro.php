...
<fieldset><legend>Filtro de Venta</legend>
    ...
    <label for="cmb_fil_ven_est" title="Estado">Est:</label>
	<select name="cmb_fil_ven_est" id="cmb_fil_ven_est">
	  <option value="">-</option>
	  <option value="CANCELADA" selected>CANCELADA</option>
	  <option value="ANULADA">ANULADA</option>
    </select>
    <?php if($_SESSION['usuariogrupo_id']==2){?><label for="chk_ven_anu" title="Activar para anular venta.">Anular<input name="chk_ven_anu" id="chk_ven_anu" type="checkbox" value="1"></label><?php }?>
  	<a href="#" onClick="ventanota_tabla()" id="btn_filtrar">Filtrar</a>
    <a href="#" onClick="ventanota_filtro()" id="btn_resfil">Restablecer</a>
</fieldset>
</form>