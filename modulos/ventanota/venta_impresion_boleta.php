...
<table border="<?php echo $borde_tablas?>">
  <tr>
    <td style="width: 125mm; height:40mm; vertical-align:top;">
        <table border="0" cellspacing="0" cellpadding="0" style="width: 124mm; height:40mm; vertical-align:top;">
        <tr>
  ...
  <tr>
    <td style="width: 100mm; vertical-align:top">
        ...
        <td style="width:120mm; font-size: 11pt;"><?php echo $cli_nom?></td>
        </tr>
        <tr>
          <td style="width: 23mm; height:6mm"><span style="font-size: 8pt;"><!--DIRECCION:--></span></td>
          <td style="width:120mm; font-size: 10pt;"><?php echo $cli_dir?></td>
        </tr>
        <tr>
          <td style="width: 23mm; height:6mm"><span style="font-size: 8pt;"><!--DOC. IDENT.:--></span></td>
        <td style="font-size: 11pt;"><?php echo $cli_doc?></td>
        </tr>
        </table>
    </td>
    <td style="width: 34mm; text-align:right;" align="right">
    <table border="<?php echo $borde_tablas?>" cellspacing="0" cellpadding="0" align="right">
      <tr>
        <td style="width: 28mm; height:6mm; text-align:right; font-size: 10pt;"><?php //echo $numdoc?></td>
        </tr>
      <tr>
        <td style="height:6mm; text-align:right; font-size: 10pt;"><?php echo $fec?></td>
        </tr>
      <tr>
        <td style="height:6mm; font-size: 8pt;"><!--DOC. IDENT.:--></td>
        </tr>
    </table></td>
  </tr>
</table>
            ...
            <tbody>
                ...
                <?php
					while($dt2 = mysql_fetch_array($dts2)){
						$importe=$dt2['tb_ventadetalle_valven']+$dt2['tb_ventadetalle_igv'];
						$precio_uni=$importe/$dt2['tb_ventadetalle_can'];
						?>
                        <tr>
