<?php
	...
	if($_SESSION['usuariogrupo_id']==2)$titulo='Registrar Notas de Venta - Administrador';
	if($_SESSION['usuariogrupo_id']==3)$titulo='Registrar Notas de Venta - Vendedor';
?>
<!DOCTYPE html>
<html>
<head>
...
function ventanota_filtro()
{
	$.ajax({
		type: "POST",
		url: "../ventanota/venta_filtro.php",
		async:true,
		dataType: "html",                      
		//data: ({
...
$(function() {
	...
	$( "#div_ventanota_check" ).dialog({
		title:'Verificando Nota de Venta...',
		autoOpen: false,
		resizable: false,
		height: 275,
		width: 500,
    	...
    	<div class="contenido">
            ...
            <table align="center" class="tabla_cont">
                  ...
                  <tr>
                    ...
                    <tr>
                      <td width="6%" align="left" valign="middle"><a id="btn_agregar" title="Agregar (A+G)" href="#" onClick="ventanota_form('insertar')">Agregar</a></td>
                      <td width="6%" align="left" valign="middle"><a id="btn_actualizar" href="#">Actualizar</a></td>
                      <td width="6%" align="left" valign="middle" nowrap>
                      <a href="#" onClick="modo('venta_tabla.php')" class="btn_modo" title="Modo Vista Notas deVenta">Notas de Venta</a>
                      </td>
                      <td width="8%" align="left" valign="middle" nowrap>
                      <a href="#" onClick="modo('venta_tabla_detalle.php')" class="btn_modo" title="Modo Vista Detalle Notas de Venta">Detalle Notas de Venta</a>
                      </td>
                      <td width="8%" align="left" valign="middle" nowrap>
                      <a href="#" onClick="modo('venta_tabla_resumen.php')" class="btn_modo" title="Resumen">Resumen</a>
                      </td>
                      <td width="6%" align="left" valign="middle"><a class="btn_imprimir_pdf" id="btn_imprimir_pdf" href="#" onClick="ventanota_reporte('venta_reporte.php')" title="Imprimir en Pdf">Reporte</a></td>
