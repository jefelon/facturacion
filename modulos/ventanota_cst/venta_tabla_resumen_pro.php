...
$dts1=$oVentanota->mostrar_resumen_productos_ventas(fecha_mysql($_POST['txt_fil_ven_fec1']),fecha_mysql($_POST['txt_fil_ven_fec2']),$cadena_categorias,$_POST['cmb_fil_pro_mar'],$_POST['hdd_fil_cli_id'],$estado,$_POST['cmb_fil_ven_ven'],$_POST['cmb_fil_ven_punven'],$_SESSION['empresa_id']);
