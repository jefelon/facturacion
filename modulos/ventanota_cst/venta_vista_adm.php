...
<title>Consulta de Notas de Venta</title>
    ...
    <article class="content">
    	<div class="contenido">
            ...
            <table align="center" class="tabla_cont">
                  <tr>
                    <td class="caption_cont">CONSULTA DE NOTAS DE VENTA</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <tr>
                      ...
                      <form action="../venta_cst - Copia/venta_reporte_xls.php" method="post" target="_blank" id="for_rep_xls">
