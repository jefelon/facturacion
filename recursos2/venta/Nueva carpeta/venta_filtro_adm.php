...
{	
	$.ajax({
		type: "POST",
		url: "../../modulos/clientes/cmb_cli_id.php",
		async:true,
		dataType: "html",                      
		data: ({
...
{	
	$.ajax({
		type: "POST",
		url: "../../modulos/usuarios/cmb_use_id.php",
		async:true,
		dataType: "html",                      
		data: ({
			usugru_id: '2,3'
...
{	
	$.ajax({
		type: "POST",
		url: "../../modulos/puntoventa/cmb_punven_id.php",
		async:true,
		dataType: "html",                      
		data: ({
			punven_id: idf
...
$(function() {
	...
	$( "#txt_fil_cli" ).autocomplete({
   		minLength: 1,
   		source: "../../modulos/clientes/cliente_complete_nom.php",
