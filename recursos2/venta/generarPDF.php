...
<p style="font-size:8px" align="center">
    Representación Impresa de la Factura Electronica. Esta puede ser consultada en: '.$server_name.'<br>
    Autorizado mediante Resolución de Intendencia N° '.$num_aprobacion.'
</p>
</body>
</html>
';
