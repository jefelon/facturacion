...
if($_POST['action']=='agregar'){
	...
	$_SESSION['venpag_mon'][]		=moneda_mysql($_POST['venpag_mon']);
	$_SESSION['venpag_for'][]		=$_POST['venpag_for'];
	$_SESSION['venpag_mod'][]		=$_POST['venpag_mod'];
	$_SESSION['venpag_cuecor'][]		=$_POST['venpag_cuecor'];
	$_SESSION['venpag_tar'][]		=$_POST['venpag_tar'];
	$_SESSION['venpag_numope'][]	=$_POST['venpag_numope'];
	$_SESSION['venpag_numdia'][]	=$_POST['venpag_numdia'];
	$_SESSION['venpag_fecven'][]	=$_POST['venpag_fecven'];
	}
}

//quitar valores del array
if($_POST['action']=='quitar'){
	unset($_SESSION['venpag_mon'][$_POST['item_id']]);
	unset($_SESSION['venpag_for'][$_POST['item_id']]);
	unset($_SESSION['venpag_mod'][$_POST['item_id']]);
	unset($_SESSION['venpag_cuecor'][$_POST['item_id']]);
	unset($_SESSION['venpag_tar'][$_POST['item_id']]);
	unset($_SESSION['venpag_numope'][$_POST['item_id']]);
	unset($_SESSION['venpag_numdia'][$_POST['item_id']]);
	unset($_SESSION['venpag_fecven'][$_POST['item_id']]);
}
...
{
	$num_rows=count($_SESSION['venpag_mon']);
...
<div id="tabla_pago_detalle" class="ui-widget" style="float:left">
        <table class="ui-widget ui-widget-content">
            ...
            <tbody>
                <?php
					foreach($_SESSION['venpag_mon'] as $indice=>$valor){
						$total+=$valor;
				?>
                        <tr>
                          <td><?php echo date('d-m-Y')?></td>
                          <td><?php 
						  	if($_SESSION['venpag_for'][$indice]==1)echo 'CONTADO ';
							if($_SESSION['venpag_for'][$indice]==2)echo 'CREDITO '.$_SESSION['venpag_numdia'][$indice].'D | FV: '.$_SESSION['venpag_fecven'][$indice];
                          ...
                          <td><?php
						  	//EFECTIVO
							if($_SESSION['venpag_mod'][$indice]==1)echo 'EFECTIVO';
							
							//DEPOSITO
							$cuecor_nom="";
							if($_SESSION['venpag_cuecor'][$indice]>0)
							{
							...
							if($_SESSION['venpag_mod'][$indice]==2)echo 'DEPOSITO '.$cuecor_nom.' N° Oper: '.$_SESSION['venpag_numope'][$indice];
							
							//TARJETA
							$tar_nom="";
							if($_SESSION['venpag_tar'][$indice]>0)
							{
							...
							if($_SESSION['venpag_mod'][$indice]==3)echo 'TARJETA '.$tar_nom.' N° Oper: '.$_SESSION['venpag_numope'][$indice];
							?></td>
