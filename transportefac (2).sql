...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-01-2019 a las 04:18:22
...
(5, 3, '2019-01-26 19:35:00', '0000-00-00 00:00:00', '100.00', 1, NULL);
...
INSERT INTO `tb_encomiendaventa` (`tb_encomiendaventa_id`, `tb_venta_id`, `tb_remitente_id`, `tb_destinatario_nom`, `tb_origen_id`, `tb_destino_id`, `tb_encomiendaventa_clave`, `tb_estado`) VALUES
(1, 53, 1, '2', 3, 1, '', 1),
(2, 54, 1, '2', 3, 1, '', 0),
(3, 55, 3, '1', 1, 2, '', 0),
(4, 56, 1, '3', 1, 2, '', 0),
...
(10, 71, 3, '1', 1, 2, '', 0),
(11, 72, 3, '1', 1, 2, '', 0),
(14, 100, 3, '1', 1, 2, '345', 0),
(15, 101, 3, '1', 1, 3, '333', 0),
(16, 105, 0, '34', 1, 5, '1234', 0),
(17, 106, 44, '34', 1, 5, '1234', 1),
(18, 114, 37, '0', 0, 0, '', 0),
(19, 115, 44, 'el pelotero', 1, 2, '2322', 1),
(20, 120, 45, 'portal academico', 1, 2, '1234', 0),
(21, 125, 45, 'porq no funciona', 1, 2, '3233', 0),
(22, 126, 7, 'CHACCA KANA DONAL', 1, 5, '11111', 0),
(23, 128, 60, 'juana luisa', 1, 2, '12345', 0),
(24, 129, 7, 'JULIA TORRES VEGAZO', 1, 3, '12345', 0);
...
(17, '2016-11-26 17:49:45', '2019-01-26 21:59:13', 'F001', 1, 99999, 75, 1, 11, 'ACTIVO', 1),
(19, '2016-11-27 23:12:03', '2019-01-25 21:31:29', 'B001', 1, 1300, 531, 1, 12, 'ACTIVO', 1),
...
(30, '2019-01-26 11:40:56', '2019-01-26 13:22:48', 'F001', 1, 999999, 10, 3, 11, 'ACTIVO', 1),
(31, '2019-01-26 11:41:19', '2019-01-26 19:41:32', 'B002', 1, 999999, 4, 3, 12, 'ACTIVO', 1);
...
(1, 'admin', '21232f297a57a5a743894a0e4a801fc3', '.', '.', 'REP VET MARVIC E.I.R.L.', 'rep.marvic@gmail.com', '0000-00-00 00:00:00', '2019-01-26 11:43:02', '2019-01-26 19:48:54', 0, 2, 1),
...
--
ALTER TABLE `tb_asientoestado`
  MODIFY `tb_asientoestado_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=95;
...
--
ALTER TABLE `tb_cajadetalle`
  MODIFY `tb_cajadetalle_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `tb_cliente`
  MODIFY `tb_cliente_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=62;

--
-- AUTO_INCREMENT de la tabla `tb_clientecuenta`
--
ALTER TABLE `tb_clientecuenta`
  MODIFY `tb_clientecuenta_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=236;
...
--
ALTER TABLE `tb_encomiendaventa`
  MODIFY `tb_encomiendaventa_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
...
--
ALTER TABLE `tb_ingreso`
  MODIFY `tb_ingreso_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=118;
...
--
ALTER TABLE `tb_kardex`
  MODIFY `tb_kardex_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=119;
...
--
ALTER TABLE `tb_servicio`
  MODIFY `tb_servicio_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `tb_talonario`
  MODIFY `tb_talonario_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
...
--
ALTER TABLE `tb_venta`
  MODIFY `tb_venta_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=131;
...
--
ALTER TABLE `tb_ventadetalle`
  MODIFY `tb_ventadetalle_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=119;
...
--
ALTER TABLE `tb_ventapago`
  MODIFY `tb_ventapago_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=119;

--
-- AUTO_INCREMENT de la tabla `tb_viajehorario`
--
ALTER TABLE `tb_viajehorario`
  MODIFY `tb_viajehorario_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;

--
-- AUTO_INCREMENT de la tabla `tb_viajeventa`
--
ALTER TABLE `tb_viajeventa`
  MODIFY `tb_viajeventa_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=101;
